...
echo Building reference-sinusoid-FDSN-Plus.xseed
mseedconvert baseline-record-sinusoid.mseed -R 11 -eh ExtraHeader-FDSN-Plus.json -o reference-sinusoid-FDSN-Plus.xseed
xseed2json -d reference-sinusoid-FDSN-Plus.xseed > reference-sinusoid-FDSN-Plus.json
xseed2text -d reference-sinusoid-FDSN-Plus.xseed > reference-sinusoid-FDSN-Plus.txt
